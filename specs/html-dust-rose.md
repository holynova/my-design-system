...
A functional-minimalist, content-forward design language with editorial warmth, recolored in a low-saturation muted rose, parchment, and quiet olive gray palette.
...
- **Warm minimalism** 鈥?clean but not cold; dust rose low-saturation palette
...
| Token     | Hex       | Role |
|-----------|-----------|------|
| `--ivory` | `#F8F5F2` | Page background |
| `--paper` | `#FFFDFC` | Card / surface background |
| `--slate` | `#211F1E` | Primary text (near-black) |
| `--clay`  | `#B78278` | Primary accent, links, highlights |
| `--clay-d`| `#95675F` | Darker accent (hover) |
| `--oat`   | `#E6D9D4` | Secondary surface, decorative, hover thumb bg |
| `--olive` | `#7E8070` | Secondary accent (charts, diagrams) |
| `--g100`  | `#F0EAE6` | Light gray surface, thumb bg |
| `--g200`  | `#E4DAD5` | Light border |
| `--g300`  | `#D0C4BE` | Default border |
| `--g500`  | `#877E7A` | Secondary / muted text |
| `--g700`  | `#443F3D` | Body text |
