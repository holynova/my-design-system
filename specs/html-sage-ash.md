...
A functional-minimalist, content-forward design language with editorial warmth, recolored in a low-saturation soft sage, ash, and weathered taupe palette.
...
- **Warm minimalism** 鈥?clean but not cold; sage ash low-saturation palette
...
| Token     | Hex       | Role |
|-----------|-----------|------|
| `--ivory` | `#F7F7F1` | Page background |
| `--paper` | `#FFFDF8` | Card / surface background |
| `--slate` | `#20211D` | Primary text (near-black) |
| `--clay`  | `#9A8068` | Primary accent, links, highlights |
| `--clay-d`| `#7F6854` | Darker accent (hover) |
| `--oat`   | `#DDD8C9` | Secondary surface, decorative, hover thumb bg |
| `--olive` | `#75806B` | Secondary accent (charts, diagrams) |
| `--g100`  | `#EFEEE5` | Light gray surface, thumb bg |
| `--g200`  | `#E1DED2` | Light border |
| `--g300`  | `#CDC8B9` | Default border |
| `--g500`  | `#848279` | Secondary / muted text |
| `--g700`  | `#43433E` | Body text |
